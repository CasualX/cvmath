...
macro_rules! vec {
	(
		...
		impl<T: Scalar> $vec<T> {
			...
			///
			/// <!--LEN_HAT--><svg width="420" height="120" viewBox="0 0 420 120" preserveAspectRatio="xMidYMid meet" font-family="monospace" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M40 100 L360.5 20 M353.70688 25.818361 L360.5 20 L351.76944 18.056509" stroke="white" /><path fill="none" d="M40 100 L360.5 100 M352.5 104 L360.5 100 L352.5 96" stroke="grey" stroke-width="0.5" /><path fill="none" d="M360.5 100 L360.5 20 M364.5 28 L360.5 20 L356.5 28" stroke="grey" stroke-width="0.5" /><circle cx="40" cy="100" r="2" fill="white" /><text x="365.5" y="20" fill="white">this</text><text x="200.25" y="115" fill="grey">x</text><text x="365.5" y="60" fill="grey">y</text></svg>
			///
			/// ```
			/// use cvmath::{Vec2, Vec3};
			///
			...
			///
			/// <!--DISTANCE_HAT--><svg width="420" height="120" viewBox="0 0 420 120" preserveAspectRatio="xMidYMid meet" font-family="monospace" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="100" x2="360.5" y2="20" stroke="white" /><path fill="none" d="M40 100 L360.5 100 M352.5 104 L360.5 100 L352.5 96" stroke="grey" stroke-width="0.5" /><path fill="none" d="M360.5 100 L360.5 20 M364.5 28 L360.5 20 L356.5 28" stroke="grey" stroke-width="0.5" /><circle cx="40" cy="100" r="2" fill="white" /><circle cx="360.5" cy="20" r="2" fill="white" /><text x="20" y="90" fill="white">this</text><text x="365.5" y="20" fill="white">to</text><text x="200.25" y="115" fill="grey">x</text><text x="365.5" y="60" fill="grey">y</text></svg>
			///
			/// ```
			/// use cvmath::{Vec2, Vec3};
			///
			...
			///
			/// <!--PROJECT_SCALAR--><svg width="400" height="200" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid meet" font-family="monospace" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M40 160 L200 20 M196.6134 28.278343 L200 20 L191.34537 22.257729" stroke="white" /><path fill="none" d="M40 160 L360 120 M352.5579 124.96139 L360 120 L351.56564 117.02317" stroke="white" /><circle cx="40" cy="160" r="2" fill="white" /><line x1="214.76923" y1="138.15384" x2="200" y2="20" stroke="white" stroke-dasharray="5.0, 5.0" stroke-width="0.5" /><line x1="194.92368" y1="140.63454" x2="192.44298" y2="120.78898" stroke="white" stroke-width="0.5" /><line x1="192.44298" y1="120.78898" x2="212.28854" y2="118.30828" stroke="white" stroke-width="0.5" /><line x1="41.860523" y1="174.88417" x2="216.62975" y2="153.03801" stroke="red" stroke-width="1.5" /><line x1="41.395393" y1="171.16313" x2="42.325653" y2="178.60521" stroke="red" stroke-width="1.5" /><line x1="216.16461" y1="149.31697" x2="217.09488" y2="156.75905" stroke="red" stroke-width="1.5" /><text x="205" y="25" fill="white">self</text><text x="340" y="142" fill="white">v</text></svg>
			///
			/// ```
			/// use cvmath::{Vec2, Vec3};
			///
			...
			///
			/// <!--REFLECT_2D--><svg width="400" height="200" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid meet" font-family="monospace" xmlns="http://www.w3.org/2000/svg"><line x1="140" y1="20" x2="175.29413" y2="161.17647" stroke="white" stroke-width="0.5" stroke-dasharray="5.0, 5.0" /><line x1="157.64706" y1="90.588234" x2="57.647064" y2="190.58823" stroke="white" stroke-width="0.5" stroke-dasharray="5.0, 5.0" /><line x1="57.647064" y1="190.58823" x2="175.29413" y2="161.17647" stroke="white" stroke-width="0.5" stroke-dasharray="5.0, 5.0" /><path fill="none" d="M40 120 L290 57.5 M283.209 63.320854 L290 57.5 L281.2687 55.559715" stroke="white" /><path fill="none" d="M40 120 L140 20 M137.17157 28.485283 L140 20 L131.51471 22.828426" stroke="white" /><path fill="none" d="M40 120 L175.29413 161.17647 M166.47609 162.67386 L175.29413 161.17647 L168.80537 155.02048" stroke="red" /><circle cx="157.64706" cy="90.588234" r="2" fill="white" /><text x="290" y="57.5" fill="white">v</text><text x="140" y="20" fill="white">self</text><text x="165.64706" y="100.588234" fill="white">p</text><text x="175.29413" y="161.17647" fill="red">result</text><text x="52.647064" y="175.58823" fill="white">-self</text><text x="151.76471" y="182.05882" fill="white">+p</text></svg>
			///
			/// <!--REFLECT_3D-->
			///
			/// ```
			...
			///
			/// <!--LERP--><svg width="400" height="120" viewBox="0 0 400 120" preserveAspectRatio="xMidYMid meet" font-family="monospace" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="100" x2="104" y2="84" stroke="lime" /><line x1="104" y1="84" x2="200" y2="60" stroke="deepskyblue" /><line x1="200" y1="60" x2="360" y2="20" stroke="white" /><circle cx="40" cy="100" r="2" fill="white" /><circle cx="360" cy="20" r="2" fill="white" /><circle cx="104" cy="84" r="2" fill="lime" /><circle cx="200" cy="60" r="2" fill="deepskyblue" /><text x="20" y="90" fill="white">self</text><text x="345" y="40" fill="white">rhs</text><text x="84" y="104" fill="lime">t = 0.2</text><text x="180" y="80" fill="deepskyblue">t = 0.5</text></svg>
			#[inline]
			#[must_use]
			...
			///
			/// <!--SLERP--><svg width="400" height="140" viewBox="0 0 400 140" preserveAspectRatio="xMidYMid meet" font-family="monospace" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M200 136.33249 L100 70 M108.87775 71.08883 L100 70 L104.45558 77.7555" stroke="white" stroke-width="0.5" /><path fill="none" d="M200 136.33249 L300 70 M295.54443 77.7555 L300 70 L291.12225 71.08883" stroke="white" stroke-width="0.5" /><path fill="none" d="M200 136.33249 L143.25452 30.597206 M150.56206 35.754707 L143.25452 30.597206 L143.51305 39.537743" stroke="lime" stroke-width="0.25" /><path fill="none" d="M200 136.33249 L200 16.332481 M204 24.332481 L200 16.332481 L196 24.332481" stroke="lime" stroke-width="0.25" /><path fill="none" d="M200 136.33249 L256.74548 30.597214 M256.48697 39.53775 L256.74548 30.597214 L249.43794 35.754715" stroke="lime" /><path fill="none" d="M88.95003 90.85828 A120 120 0 0 1 100 70" stroke="white" stroke-width="0.5" /><path fill="none" d="M100 70 A120 120 0 0 1 256.74548 30.597214" stroke="lime" /><path fill="none" d="M256.74548 30.597214 A120 120 0 0 1 300 70" stroke="white" /><path fill="none" d="M300 70 A120 120 0 0 1 311.05 90.85829" stroke="white" stroke-width="0.5" /><line x1="100" y1="70" x2="250" y2="70" stroke="deepskyblue" stroke-width="0.5" /><circle cx="100" cy="70" r="2" fill="white" /><circle cx="300" cy="70" r="2" fill="white" /><circle cx="250" cy="70" r="2" fill="deepskyblue" /><circle cx="256.74548" cy="30.597214" r="2" fill="lime" /><text x="98.25452" y="25.597206" fill="lime" font-size="10">t = 0.25</text><text x="180" y="11.332481" fill="lime" font-size="10">t = 0.50</text><text x="256.74548" y="25.597214" fill="lime" font-size="10">t = 0.75</text><text x="230" y="90" fill="deepskyblue">lerp</text><text x="196.74548" y="40.597214" fill="lime">slerp</text><text x="50" y="70" fill="white">self</text><text x="310" y="70" fill="white">rhs</text></svg>
			#[inline]
			#[must_use]
			...
			///
			/// <!--NLERP--><svg width="400" height="140" viewBox="0 0 400 140" preserveAspectRatio="xMidYMid meet" font-family="monospace" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M200 136.33249 L100 70 M108.87775 71.08883 L100 70 L104.45558 77.7555" stroke="white" stroke-width="0.5" /><path fill="none" d="M200 136.33249 L300 70 M295.54443 77.7555 L300 70 L291.12225 71.08883" stroke="white" stroke-width="0.5" /><path fill="none" d="M200 136.33249 L127.768486 40.50657 M135.77812 44.487244 L127.768486 40.50657 L129.38972 49.30268" stroke="lime" stroke-width="0.25" /><path fill="none" d="M200 136.33249 L200 16.332497 M204 24.332497 L200 16.332497 L196 24.332497" stroke="lime" stroke-width="0.25" /><path fill="none" d="M200 136.33249 L272.2315 40.50657 M270.61026 49.30268 L272.2315 40.50657 L264.2219 44.487244" stroke="lime" /><path fill="none" d="M94.97722 78.27897 A120 120 0 0 1 100 70" stroke="white" stroke-width="0.5" /><path fill="none" d="M100 70 A120 120 0 0 1 272.2315 40.50657" stroke="lime" /><path fill="none" d="M272.2315 40.50657 A120 120 0 0 1 300 70" stroke="white" /><path fill="none" d="M300 70 A120 120 0 0 1 305.02277 78.27897" stroke="white" stroke-width="0.5" /><line x1="100" y1="70" x2="250" y2="70" stroke="deepskyblue" stroke-width="0.5" /><circle cx="100" cy="70" r="2" fill="white" /><circle cx="300" cy="70" r="2" fill="white" /><circle cx="250" cy="70" r="2" fill="deepskyblue" /><circle cx="272.2315" cy="40.50657" r="2" fill="lime" /><text x="82.768486" y="35.50657" fill="lime" font-size="10">t = 0.25</text><text x="180" y="11.332497" fill="lime" font-size="10">t = 0.50</text><text x="272.2315" y="35.50657" fill="lime" font-size="10">t = 0.75</text><text x="230" y="90" fill="deepskyblue">lerp</text><text x="212.2315" y="50.50657" fill="lime">nlerp</text><text x="50" y="70" fill="white">self</text><text x="310" y="70" fill="white">rhs</text></svg>
			#[inline]
			#[must_use]
