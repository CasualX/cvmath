...
///
/// <!--SCALAR_STEP--><svg width="420" height="140" viewBox="0 0 420 140" preserveAspectRatio="xMidYMid meet" font-family="monospace" xmlns="http://www.w3.org/2000/svg"><text x="10" y="120" fill="white">0</text><text x="10" y="20" fill="white">1</text><line x1="40" y1="120" x2="200" y2="120" stroke="white" /><line x1="200" y1="120" x2="200" y2="20" stroke="grey" stroke-dasharray="5.0, 5.0" /><line x1="200" y1="20" x2="380" y2="20" stroke="white" /><text x="240" y="35" fill="white">x ≥ edge</text><text x="100" y="135" fill="white">x < edge</text></svg>
#[inline]
