...
- 2D geometry: [tyalias@Point2], [struct@Bounds2], [struct@Rect], [struct@Line2], [struct@Plane2], [struct@Circle], [struct@Capsule2], [struct@Triangle2], [enum@Shape2]
- 3D geometry: [tyalias@Point3], [struct@Bounds3], [struct@Line3], [struct@Plane3], [struct@Sphere], [struct@Capsule3], [struct@Triangle3], [enum@Shape3]
- 2D ray tracing: [struct@Ray2], [struct@Hit2], [trait@Trace2], [struct@Bvh2]
- 3D ray tracing: [struct@Ray3], [struct@Hit3], [trait@Trace3], [struct@Bvh3]
